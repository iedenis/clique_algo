...
public class Clique_Tester {
	...
	public static void main(String[] args) throws IOException {
		System.out.println(
				"*****************************************************************************************************************************");
		System.out.println(
				"* In this project we make comparison between two functions: All_Cliques_DFS and All_Cliques_DFS_2 (improved All_Cliques_DFS)*"
		...
		initTest();
		System.out.println("===========================================================================\n");
		System.out.println("Our improved algorithm takes: " + (t3 - t2) + " ms\nWith the graph built from file -->> "
				+ parseFileName(in_file) + "\n" + "\nThe improved the algorithm works " + ((diff - (t3 - t2))>0?"faster ":"slower ") + Math.abs(diff - (t3 - t2))+" ms\n");
		System.out.println("The biggest clique in the test1 graph is: " + G.sizeOfBiggestClique(sizeOfSClique));
		System.out.println("The biggest clique in graph by the second algorithm is: " + G.Main_Max_Clique());
		...
		System.out.println("The biggest clique in graph by the second algorithm is: " + G1.Main_Max_Clique());
	...
	public boolean isBetter(int diff, int t2, int t3) {
		return (diff-(t3 - t2)< 0) ? false : true;
	}
